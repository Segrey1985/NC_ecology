...
class Flora(BaseModel):
    ...
    region_description: str = Field(
        ...,
        description=(
            "Общая характеристика растительности региона/субъекта РФ. "
            "Пример: «Растительный покров Ленинградской области отличается "
    ...
    site_surface_description: str = Field(
        ...
        description=(
            ...
            "Примеры: «представляет собой асфальтированную площадку»; "
            "«занята нарушенной рудеральной растительностью»."
        ),
    )
    ...
    authority_letter_text: Optional[str] = Field(
        None,
        description=(
            "Текст со ссылкой на письмо уполномоченного органа (Комитет по природным "
            "ресурсам, КГИОП и т.п.) об отсутствии охраняемых видов. "
            "Пример: «Согласно письму Комитета по природным ресурсам Ленинградской "
            "области от 01.01.2024 № 123 на участке охраняемые виды не выявлены.»"
        ),
    )
    red_book_region: str = Field(
        ...,
        description=(
            "Наименование региональной Красной книги. "
            "Пример: «Красную книгу Санкт-Петербурга»; "
            "«Красную книгу Ленинградской области»."
        ),
    )
    work_impact_note: Optional[str] = Field(
        None,
        description=(
            "Дополнительное примечание о воздействии на растительность "
            "при проведении работ (опционально). "
            "Пример: «При проведении земляных работ верхний слой почвы "
            "будет снят и складирован для последующей рекультивации.»"
        ),
    )
...
class Fauna(BaseModel):
    ...
    site_fauna_description: str = Field(
        ...
        description=(
            ...
            "Примеры: «синантропными видами птиц (воробей, голубь)»; "
            "«обычными видами птиц урбанизированных территорий»."
        ),
    )
    authority_letter_text: Optional[str] = Field(
        None,
